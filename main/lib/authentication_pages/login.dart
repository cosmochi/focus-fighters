  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        children: [
          Text(
            "Login", style: TextStyle(fontSize: 27,fontWeight: FontWeight.bold), 
          ),
          SizedBox(
            height: 30,
            ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: currentlySigningIn ? CircularProgressIndicator(color: Colors.white,) : Text("Login", style: TextStyle(
                      color: Colors.white, 
    ...
    User? user = await _auth.emailAndPassSignIn(email, password);
